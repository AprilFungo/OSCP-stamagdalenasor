...
<?php 
    ...
    if (isset($_POST['updateBtn']))
    {
      ...
      if ($currentpass == md5($oldpass))
      {
        ...
        {
          // update
          $q = @mysqli_query($dbc, "UPDATE tbl_admin SET clm_name = '$name', clm_username = '$username', clm_password = md5('$newpass') WHERE clm_adminid = '$adminid' ");
          if ($q)
          {
                          ...
                          <div class="row">
                            <div class="col-md-6 m-auto">
                              ...
                              <form action="" method="POST">
                                ...
                                <input required type="text" name="name" value="<?php echo $fullname; ?>" class="form-control"><br>
