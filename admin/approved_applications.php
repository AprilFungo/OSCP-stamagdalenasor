                    ...
                    <div class="card">
                        <div class="card-body">
                          <?php
                            ...
                            $q = @mysqli_query($dbc, "SELECT *, DATE_FORMAT(clm_date, '%b %e, %Y') as DateFiled, DATE_FORMAT(clm_date_status, '%b %e, %Y') as DateStatus FROM tbl_applications WHERE clm_status = 2 ORDER BY clm_date_status DESC");
                            ...
                            {
                              echo'<h3 style="margin-top: 10px; margin-bottom: 50px;">Approved applications will appear here.</h3>';
                            }
                          ?> 
                        </div>
                    </div>
...
$(document).ready(function(){ 
  ...
  $('.viewappBtn').click(function(){  
    ...
    var pageName = 'approved_applications';  
    $.ajax({  
